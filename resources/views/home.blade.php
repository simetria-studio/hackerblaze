...
@section('content')
    ...
    <div class="main">
        ...
        <div class="instagram text-center mt-1 text-light">
            <a href="https://www.instagram.com/hacker.da.blaze/?igshid=YmMyMTA2M2Y=" target="_blank"> <img width="30" src="{{ asset('assets/img/instagram.svg') }}" alt=""></a>
            <h4 class="my-2">@hacker.da.blaze</h4>
        </div>
